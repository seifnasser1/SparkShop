...
$allproducts=db_select('allpros','1 ORDER BY id DESC '); //ERROR- fixed
$racket=db_select('rackets_trial','1 ORDER BY id DESC ');
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="img/SparkPadel.jpg">
    <link rel="icon" type="image/png" sizes="16x16" href="img/SparkPadel.jpg">
  ...
  <body class="handheld-toolbar-enabled">
    ...
    <div id="glasses" class="accordion-collapse collapse" aria-labelledby="glasses">
        <div class="accordion-body" id="glassesContent"></div>
          ...
          <section class="col-lg-8">
            ...
            <!-- Products grid-->
             <div class="row mx-n2">
                <?php foreach($allproducts as $key=>$pro){ ?>
              <!-- Product-->
    ...
    <?php  
                        $con = mysqli_connect("localhost","root","","SparkShop");
